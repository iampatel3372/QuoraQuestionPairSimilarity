...
Original file is located at
    https://colab.research.google.com/drive/1QgvvM41gACGWZVV3_5t0X-KUjkccbzUi
...
data = pd.read_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/train.csv')
data.head()
...
if os.path.isfile('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/cleaned_featurized_train.csv'):
  train_data = pd.read_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/cleaned_featurized_train.csv')
  train_labels = np.load('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/train_labels.npy')
 
  test_data = pd.read_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/cleaned_featurized_test.csv')
  test_labels = np.load('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/test_labels.npy')
else:
  # x = extract_features(train_data)
  train_data = extract_features(train_data)
  train_data.to_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/cleaned_featurized_train.csv', index=False)
  np.save('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/train_labels.npy', train_labels)


  test_data = extract_features(test_data)
  test_data.to_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/cleaned_featurized_test.csv', index=False)
  np.save('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/test_labels.npy', test_labels)
...
q1_w2v_train.to_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q1_w2v_train.csv')

print('Saving train question2')
q2_w2v_train.to_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q2_w2v_train.csv')

print('Saving test question1')
q1_w2v_test.to_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q1_w2v_test.csv')

print('Saving test question2')
q2_w2v_test.to_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q2_w2v_test.csv')

"""#### Load from disk"""

# Reading from disk
print('Reading .csv files from disk')
q1_w2v_train = pd.read_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q1_w2v_train.csv')
q2_w2v_train = pd.read_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q2_w2v_train.csv')

q1_w2v_train = q1_w2v_train.drop(columns=['Unnamed: 0'])
q2_w2v_train = q2_w2v_train.drop(columns=['Unnamed: 0'])

q1_w2v_test = pd.read_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q1_w2v_test.csv')
q2_w2v_test = pd.read_csv('/content/drive/My Drive/ML_Projects/QuoraQuestionPairSimilarity/q2_w2v_test.csv')
...
table.field_names = ['Model', 'Dimensionality', 'Regularization', 'Regularization', 'Train log-loss', 'Test log-loss']
